...
响应项包含 `id`、`businessRegionId`、`name`、`code`、`address`、`lng`、`lat`、`tags`、`sort` 和 `createTime`。
...
- 字段：`id`、`tenant_id`、`business_region_id`、`dept_id`、`name`、`code`、`address`、`lng`、`lat`、`tags`、`sort`、`creator`、`create_time`、`updater`、`update_time`、`deleted`。
